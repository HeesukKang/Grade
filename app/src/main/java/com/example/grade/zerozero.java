...
public class zerozero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zerozero);
...
//                계산할때마다 전부 0으로 초기화해서 다시 계산한다.
                ...
                saveExcel(oneonesubject, oneonecredit, oneonegrade, checktoonezero);
    ...
    private void saveExcel(String[] subject, double[] credit, String[] grade, int[] checktoonezero) {
        ...
        switch (sheetnum) {
            case 1:
                ...
                for (int i = 0; i < 10; i++) {
                    ...
                    cell = row.createCell(2);
                    cell.setCellValue(credit[i]);
                    cell = row.createCell(3);
                    cell.setCellValue(grade[i]);
                    cell = row.createCell(4);
                    cell.setCellValue(checktoonezero[i]);
                }
                break;
            case 2:
